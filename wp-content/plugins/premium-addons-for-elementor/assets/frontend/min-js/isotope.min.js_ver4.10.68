    ...
    (u.infinitescroll = function (t, e, i) {
      ...
      (u.infinitescroll.prototype = {
        _binding: function (t) {
          ...
          if (
            ((i.v = "2.0b2.120520"),
            i.behavior && this["_binding_" + i.behavior] !== l)
          )
        ...
        _create: function (t, o) {
          ...
          (n.path = n.path || this._determinepath(e)),
            ...
            n.pixelsFromNavToBottom === l &&
              ((n.pixelsFromNavToBottom =
                u(document).height() - u(n.navSelector).offset().top),
          ...
          return (
            (n.loading.start =
              n.loading.start ||
              function () {
                u(n.navSelector).hide(),
                  n.loading.msg.appendTo(n.loading.selector).show(
                    n.loading.speed,
                    u.proxy(function () {
                      this.beginAjax(n);
                    }, i)
            ...
            (n.loading.finished =
              n.loading.finished ||
              function () {
                n.state.isBeyondMaxPage ||
                  n.loading.msg.fadeOut(n.loading.speed);
              }),
            (n.callback = function (t, e, i) {
              n.behavior &&
                t["_callback_" + n.behavior] !== l &&
                t["_callback_" + n.behavior].call(
                  u(n.contentSelector)[0],
                  e,
                  i
                ),
                o && o.call(u(n.contentSelector)[0], e, n, i),
                n.prefill && s.bind("resize.infinite-scroll", t._prefill);
            }),
            t.debug &&
        ...
        _determinepath: function (t) {
          var e = this.options;
          if (e.behavior && this["_determinepath_" + e.behavior] !== l)
        ...
        _error: function (t) {
          var e = this.options;
          e.behavior && this["_error_" + e.behavior] !== l
        ...
        _loadcallback: function (t, e, i) {
          var o,
            ...
            r = n.state.isDone
              ...
              ? "append"
              : "no-append";
          if (n.behavior && this["_loadcallback_" + n.behavior] !== l)
            this["_loadcallback_" + n.behavior].call(this, t, e);
          else {
            switch (r) {
              case "done":
              ...
              case "no-append":
                if (
                  ("html" === n.dataType &&
                    (e = u((e = "<div>" + e + "</div>")).find(n.itemSelector)),
                  0 === e.length)
                )
              ...
              case "append":
                ...
                for (o = document.createDocumentFragment(); t[0].firstChild; )
                  o.appendChild(t[0].firstChild);
                this._debug("contentSelector", u(n.contentSelector)[0]),
                  u(n.contentSelector)[0].appendChild(o),
                  (e = a.get());
            }
            if (
              (n.loading.finished.call(u(n.contentSelector)[0], n), n.animate)
            ) {
              var h =
                u(window).scrollTop() +
                u(n.loading.msg).height() +
                n.extraScrollPx +
                "px";
              u("html,body").animate({ scrollTop: h }, 800, function () {
                n.state.isDuringAjax = !1;
              });
            }
            n.animate || (n.state.isDuringAjax = !1),
              s(this, e, i),
              n.prefill && this._prefill();
          }
        },
        _nearbottom: function () {
          var t = this.options,
            e =
              ...
              t.binder.scrollTop() -
              u(window).height();
          return t.behavior && this["_nearbottom_" + t.behavior] !== l
        ...
        _setup: function () {
          var t = this.options;
          if (!t.behavior || this["_setup_" + t.behavior] === l)
            return this._binding("bind"), !1;
          this["_setup_" + t.behavior].call(this);
        },
        _showdonemsg: function () {
          var t = this.options;
          t.behavior && this["_showdonemsg_" + t.behavior] !== l
        ...
        _validate: function (t) {
          for (var e in t)
            if (e.indexOf && -1 < e.indexOf("Selector") && 0 === u(t[e]).length)
        ...
        beginAjax: function (n) {
          ...
          if (
            (n.state.currPage++,
            n.maxPage !== l && n.state.currPage > n.maxPage)
          )
            return (n.state.isBeyondMaxPage = !0), void this.destroy();
          switch (
            ((s = u(n.contentSelector).is("table, tbody")
              ? u("<tbody/>")
              : u("<div/>")),
            (r =
              "function" == typeof e
                ? e(n.state.currPage)
                : e.join(n.state.currPage)),
            h._debug("heading into ajax", r),
            (t =
              "html" === n.dataType || "json" === n.dataType
                ? n.dataType
                : "html+callback"),
            n.appendCallback && "html" === n.dataType && (t += "+callback"),
            t)
          ) {
            case "html+callback":
              h._debug("Using HTML via .load() method"),
                s.load(r + " " + n.itemSelector, l, function (t) {
                  h._loadcallback(s, t, r);
                });
              break;
            case "html":
              h._debug("Using " + t.toUpperCase() + " via $.ajax() method"),
                u.ajax({
                  url: r,
                  dataType: n.dataType,
                  complete: function (t, e) {
                    (a =
                      ...
                      ? h._loadcallback(s, t.responseText, r)
                      : h._error("end");
                  },
                });
              break;
                  ...
                  success: function (t, e, i) {
                    if (
                      ...
                      if (n.template !== l) {
                        var o = n.template(t);
                        s.append(o),
                          a ? h._loadcallback(s, o) : h._error("end");
                      } else
        ...
        retrieve: function (t) {
          t = t || null;
          var e = this.options;
          if (e.behavior && this["retrieve_" + e.behavior] !== l)
            this["retrieve_" + e.behavior].call(this, t);
          else {
            if (e.state.isDestroyed)
              return this._debug("Instance is destroyed"), !1;
            (e.state.isDuringAjax = !0),
              e.loading.start.call(u(e.contentSelector)[0], e);
          }
        },
        scroll: function () {
          var t = this.options,
            e = t.state;
          t.behavior && this["scroll_" + t.behavior] !== l
        ...
        switch (typeof e) {
          ...
          case "object":
            this.each(function () {
              ...
              t
                ? t.update(e)
                : (t = new u.infinitescroll(e, i, this)).failed ||
                  u.data(this, "infinitescroll", t);
            });
        }
        return this;
      });
