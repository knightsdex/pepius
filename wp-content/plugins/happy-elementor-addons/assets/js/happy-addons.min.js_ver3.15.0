        ...
        a = t.extend({
          onInit: function () {
            t.prototype.onInit.apply(this, arguments),
              this.run(),
              this.runFilter(),
              l.on("resize", d(this.run.bind(this), 100));
          },
                    ...
                    eventClick: function (e) {
                      if ("yes" == S) {
                        ...
                        y.css("display", "none"),
                          ...
                          c &&
                            (y.removeAttr("style"),
                            y.find("img").attr("src", c),
                            y.find("img").attr("alt", i)),
                          i && (u.removeAttr("style"), u.text(i)),
                          r &&
                            (g.removeAttr("style"),
                            g.find("span.ha-ec-event-guest").text(r)),
                          l &&
                            (f.removeAttr("style"),
                          ...
                          !0 !== a
                            ? (m.removeAttr("style"),
                              ...
                              m
                                ...
                                .text(c + " - " + y))
                            : (m.removeAttr("style"),
                              m.find("span.ha-ec-event-time").text(k)),
                          h &&
                            (v.removeAttr("style"),
                            v.attr("href", h),
                        ...
                        if (e.event.url && e.event.extendedProps.external)
                          return (
                            ...
                            (i.style.display = "none"),
                            document.body.appendChild(i),
                            (w = document.getElementById(i.id)).click(),
          ...
          t.extend({
            ...
            run: function () {
              var a,
                ...
                s = this,
                r = JSON.parse(
                  s.$element.find(".ha-lhi-image-area").attr("data-settings")
                ),
              ...
              c && c.remove(),
                new hoverEffect({
                  ...
                  displacementImage:
                    r.plugin_url + "liquid-hover-image/" + r.hover_effect,
              ...
              "style-1" == u &&
                (d.length || h.length) &&
                ((a = r.style_1_direction),
                d.length &&
                  (d[0].innerHTML = d[0].textContent.replace(
                    /\S/g,
                    "<span class='letter'>$&</span>"
                  )),
                h.length && h.addClass("letter"),
                (e = [0, 0]),
                (t = [0, 0]),
                (n = [0, 0]),
                (i = [0, 0]),
                ...
                "style-2" == u &&
                  ...
                  h.length &&
                    ((o = h.find(".normal").outerHeight()), h.height(o)),
                  s.$element.hover(
                    function () {
